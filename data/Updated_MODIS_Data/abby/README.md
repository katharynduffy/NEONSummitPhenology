...
## 1. Request Parameters  
    ...
    Date Completed:** 2020-09-10T23:24:23.287816  

    Id: 7f86d505-eaf4-4c82-8c5f-bae16f93f72e  
    ...
    Details:  
        ...
        Coordinates:  
            ...
            4444, NEON.D16.ABBY.DP1.00033, 45.7633564643645, -122.331118584341  
            4445, NEON.D16.ABBY.DP1.00033, 45.7633564643645, -122.329037579869  
            4443, NEON.D16.ABBY.DP1.00033, 45.7633564643645, -122.333199588814  
            4343, NEON.D16.ABBY.DP1.00033, 45.7648082030175, -122.333199588814  
            4344, NEON.D16.ABBY.DP1.00033, 45.7648082030175, -122.331118584341  
            4345, NEON.D16.ABBY.DP1.00033, 45.7648082030175, -122.329037579869  
            4545, NEON.D16.ABBY.DP1.00033, 45.7619046879334, -122.329037579869  
            4544, NEON.D16.ABBY.DP1.00033, 45.7619046879334, -122.331118584341  
            4543, NEON.D16.ABBY.DP1.00033, 45.7619046879334, -122.333199588814  
...
- Comma-separated values file with data extracted for a specific product
  - ABBY-MOD13Q1-006-results.csv
- Comma-separated values file with data extracted for a specific product
  - ABBY-MYD13Q1-006-results.csv
- Comma-separated values file with data extracted for a specific product
  - ABBY-eMODIS-Smoothed-NDVI-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - ABBY-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - ABBY-request.json
- xml file
  - ABBY-MOD13Q1-006-metadata.xml
- xml file
  - ABBY-MYD13Q1-006-metadata.xml
- xml file
  - ABBY-eMODIS-Smoothed-NDVI-001-metadata.xml  
